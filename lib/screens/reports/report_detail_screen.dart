            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      if (isAdmin && _selectedStatus != widget.report.status) ...[
                        ...
                        ElevatedButton(
                          ...
                          child: const Text('Actualizar Estado', style: TextStyle(color: Colors.white)),
                        ),
                      ] else ...[
                  ...
                  // Botón de editar para el dueño (versión alternativa en el body)
                  if (isOwner && !isAdmin) ...[
