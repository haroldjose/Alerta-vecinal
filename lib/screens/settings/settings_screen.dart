...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
        ...
        data: (user) {
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                // Estado de conexión
                _buildConnectionStatus(connectivityStatus, currentTheme),
                ...
                // Sección: Usuarios Activos (solo para admins)
  ...
  // Estado de conexión
  Widget _buildConnectionStatus(AsyncValue<bool> connectivityStatus, AppTheme theme) {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isConnected
                        ? 'La aplicación está sincronizada'
